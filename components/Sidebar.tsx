...
const Sidebar: React.FC<SidebarProps> = ({ activeAgent }) => {
  ...
  return (
    <div className="w-72 bg-slate-900 h-screen flex flex-col hidden md:flex shadow-2xl z-20 text-white border-r border-slate-800">
      {/* Header Logo */}
      ...
      <div className="p-4 bg-slate-950 border-t border-slate-800">
        <div className="flex items-center space-x-3 bg-slate-900 p-3 rounded-xl border border-slate-800 hover:border-slate-700 transition-colors cursor-pointer group">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold text-slate-200 truncate">Dr. Arief Wibowo</p>
